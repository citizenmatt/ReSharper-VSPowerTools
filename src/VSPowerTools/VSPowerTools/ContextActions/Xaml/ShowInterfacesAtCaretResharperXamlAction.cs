...
namespace VSPowerTools.ContextActions
{
#if(DEBUG)
	[ContextAction(Name = "ShowInterfacesAtCaretXamlAction", Description = "Shows all interfaces at caret", Group = "XAML")]
	public class ShowInterfacesAtCaretResharperXamlAction : ContextActionBase
	{
		private readonly XamlContextActionDataProvider _provider;
		private ITreeNode _currentTreeNode;

		public ShowInterfacesAtCaretResharperXamlAction(XamlContextActionDataProvider provider)
		{
			_provider = provider;
		}
