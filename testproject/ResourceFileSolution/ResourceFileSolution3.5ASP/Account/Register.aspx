<%@ Page Title="Registrieren" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Register.aspx.cs" Inherits="ResourceFileSolution3._5ASP.Account.Register" %>
        ...
        <WizardSteps>
            <asp:CreateUserWizardStep ID="RegisterUserWizardStep" runat="server">
                <ContentTemplate>
                    ...
                    <p>
                        Verwenden Sie das Formular unten, um ein neues Konto zu erstellen.
                    </p>
                    <p>
                        ...
                        <fieldset class="register">
                            ...
                            <p>
                                ...
                                <asp:RequiredFieldValidator ControlToValidate="ConfirmPassword" CssClass="failureNotification" Display="Dynamic" 
                                     ErrorMessage="Die Bestätigung des Kennworts ist erforderlich." ID="ConfirmPasswordRequired" runat="server" 
                                     ToolTip="Die Bestätigung des Kennworts ist erforderlich." ValidationGroup="RegisterUserValidationGroup">*</asp:RequiredFieldValidator>
